...
| 3.16 | ~~Đóng phần còn nợ của OSS-003~~ ✅ **Xong 2026-08-08 — relicense** | [`LICENSE-MIT`](../../LICENSE-MIT) · [`LICENSE-APACHE`](../../LICENSE-APACHE) · [`CONTRIBUTING.md`](../../CONTRIBUTING.md) | Dự án chuyển sang nguồn mở `MIT OR Apache-2.0`; `LICENSE` proprietary đã xoá. Phạm vi code / tài liệu / asset và định dạng `.anmw` được nêu trong README; metadata npm/Cargo và chính sách đóng góp cùng dùng biểu thức SPDX này. |
