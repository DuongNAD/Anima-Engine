...
Đây là số đo, không phải trích dẫn tài liệu. **Toàn bộ bảng** được chạy lại tại `d006f64`
(nhánh `feat/oss-071b-live-tracker`, trên `main` sau khi #19 merge).
...
>
> **Sửa một điều §4 và bản trước của mục này ghi sai: con số KHÔNG phải dấu hiệu nhận dạng.** Nó
