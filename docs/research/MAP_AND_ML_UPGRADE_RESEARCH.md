...
**Nửa sau — gộp không gian và agent tổng hợp — cũng đã ship**, ở `core/aggregate_population.rs`:
agent ngủ bị huỷ hẳn, còn lại là thống kê theo chunk 32×32, và nở lại thành cá thể khi observer quay
về. Bảo toàn năng lượng gói gọn trong một nhận định: **con vật ngủ vẫn là con vật**, nên không có
compartment thứ tư và không có giao dịch ledger — census cộng thêm năng lượng ngủ vào `pool.animals`.

**Nhưng con số mà mục này lấy làm lý do xếp A6 lên hàng 0 chỉ đúng ở một chế độ.** Trần quy mô là
bộ nhớ; tiết kiệm bộ nhớ thì **có điều kiện**:

- Cohort **≤ 8 cá thể**: archive giữ **đủ mọi genome** (đó là cái làm cho vòng ngủ–thức không mất mát).
  Tiết kiệm chỉ là body ECS + mạng `learned` — hệ số 2, không hơn.
- Cohort **> 8**: archive dừng ở 8 genome. Bộ nhớ ngủ thành O(số chunk) thay vì O(số agent) — đây mới
  là chỗ trần thật sự nhúc nhích.

Tức là vài agent đi khuất tầm mắt gần như không tiết kiệm gì; trần chỉ mở ra ở quy mô một chunk vượt
cap — đúng quy mô mà "hàng triệu agent" sống, và cũng đúng quy mô mà ngủ trở nên **mất mát di truyền**
...
| **0b** ✅ | **A6** — Simulation-LOD backend (2 tầng) | Quy mô agent bị map chặn trước RAM; LOD là chỗ trả tiền cho độ phân giải cao hơn | ✅ headless |
