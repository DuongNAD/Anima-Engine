...
| E8 | (Next) Decomposition + coevolution metrics | Corpse → detritus decay (death half of the closed loop); explicit Red-Queen / character-displacement diagnostics; intermediate-disturbance diversity maintenance; seasonal fertility driver | TODO |
